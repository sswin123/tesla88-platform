...
ALTER TABLE brand_settings
  ...
  -- Brand Assets (extended)
  ADD COLUMN IF NOT EXISTS loading_logo_media_id INTEGER DEFAULT NULL REFERENCES media(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS pwa_icon_media_id     INTEGER DEFAULT NULL REFERENCES media(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS apple_touch_media_id  INTEGER DEFAULT NULL REFERENCES media(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS og_image_media_id     INTEGER DEFAULT NULL REFERENCES media(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS share_image_media_id  INTEGER DEFAULT NULL REFERENCES media(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS splash_image_media_id INTEGER DEFAULT NULL REFERENCES media(id) ON DELETE SET NULL,
