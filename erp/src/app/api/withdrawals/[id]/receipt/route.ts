...
// POST: attach or replace a receipt image for a withdrawal.
// Works for both AWAITING_RECEIPT (before Done) and PAID (already completed).
// Payment completion is handled by the separate /done endpoint — this route only manages the file.
