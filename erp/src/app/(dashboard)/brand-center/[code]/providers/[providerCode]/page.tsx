...
function ConfigurationTab() {
  return (
    <EmptyState
      ...
      title="Configuration"
      description="Configuration management coming in the next phase."
    />
  );
}
...
function HealthTab() {
  return (
    <EmptyState
      ...
      description="Health monitoring coming in the next phase."
    />
  );
}
...
function LogsTab() {
  return (
    <EmptyState
      icon={ScrollText}
      title="Logs"
      description="Provider logs coming in the next phase."
    />
  );
}
...
function StatisticsTab() {
  return (
    <EmptyState
      icon={BarChart3}
      title="Statistics"
      description="Provider statistics coming in the next phase."
    />
  );
}
...
function AuditTab() {
  return (
    <EmptyState
      icon={ClipboardList}
      title="Audit Trail"
      description="Audit trail coming in the next phase."
    />
  );
}
